...
export default function LanguageSelectionScreen({ route, navigation }) {
  ...
  const languages = [
    ...
    { id: 'zh-CN', name: 'simplifiedChinese', displayName: 'Simplified Chinese' },
    { id: 'it', name: 'italian', displayName: 'Italian' },
    { id: 'zh-TW', name: 'traditionalChinese', displayName: 'Traditional Chinese' },
    { id: 'es', name: 'spanish', displayName: 'Spanish' },
    { id: 'ja', name: 'japanese', displayName: 'Japanese' },
    { id: 'ko', name: 'korean', displayName: 'Korean' },
  ];
